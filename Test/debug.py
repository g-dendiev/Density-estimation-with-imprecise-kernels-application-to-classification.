...
# On tri aléatoirement l'ensemble de points obtenu.
# On prendra ensuite les n premier points souhaités que l'on retriera par ordre croissant.
tKernelTriRandomDomain = tKernelTri
tKernelTriRandomDomain = rd.shuffle(tKernelTri)

print(tKernelTriRandomDomain)
